  ...
  KNOWN_GUESTS: [
    {
      ...
      notes: [
        ...
        'If we are CLOSED (Sat–Tue or after hours): say clearly "We are closed today" — Sat–Tue always closed, open Wednesday–Friday only — then one short creator nod if natural ("You built this with Rex — you know the hours"). Do NOT pretend we are open.',
