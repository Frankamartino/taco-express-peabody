...
module.exports = async function handler(req, res) {
  ...
  const instructions = [
    ...
    shopStatus.line,
    shopOverrideLine || '',
    'Hours: Wednesday–Saturday 11 AM–8 PM. Sunday CLOSED, Monday CLOSED, Tuesday CLOSED.',
    ...
    'If CLOSED today: lead with "We are closed today." Sun–Tue are always closed. Do NOT say we are open or ready for pickup now.',
