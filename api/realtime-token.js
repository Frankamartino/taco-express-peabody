...
module.exports = async function handler(req, res) {
  ...
  const instructions = [
    ...
    'Never open a URL. Never charge without verbal yes. If confirm_and_pay says missing fields — ask for those fields, do not invent them. If needs_card_setup — say card is not set up yet (voice-signup once), then counter/call.',
